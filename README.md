...
Step 2: Create Container App(Basic)
...
Step 2: Create Container App(Container)
...
Step 2: Create Container App(Ingress)
...
Step 2: Create Container App(Review configuration, then create)
...
Step 3: Go to the newly deployed resource
...
Step 4: From the menu, navigate to the 'Application' menu. Then click "Revisions and replicas"
...
Step 5: Click "Show Logs", then the "Basics" tab to Check if application is running
...
Step 1: Configure PostgreSQL Database(Basics)
